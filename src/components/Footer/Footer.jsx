...
const Footer = () => {
  ...
  return (
    <div className='mt-auto bg-[#101010] grid grid-cols-2 h-[400px] pt-20 px-40 pb-12'>
      <div>
        <div>
        ...
        <div>
          <P className="text-white my-6">Audiophile is an all in one stop to fulfill your audio needs. We're a small team of music lovers and sound specialists who are devoted to helping you get the most out of personal audio. Come and visit our demo facility - we’re open 7 days a week.</P>
        </div>
        <div>
          <Span1>Copyright 2021. All Rights Reserved</Span1>
        </div>
      </div>
      <div>
        <div>
            <nav className='text-white flex gap-x-5 text-[13px] font-bold uppercase leading-[25px] tracking-widest justify-end'>
              <NavLink
                  to=""
