...
import Span1 from '../Typography/Span/Span1'
...
const Footer = () => {
  ...
  return (
    <div className='mt-auto bg-[#101010] lg:grid text-center lg:text-left lg:grid-cols-2 lg:h-[400px] py-16 lg:pt-20 lg:px-40 lg:pb-12 px-5'>
      <div>
        <div>
          <svg xmlns="http://www.w3.org/2000/svg" width="143" height="25" viewBox="0 0 143 25" fill="none" className='mx-auto lg:mx-0 lg:mr-auto'>
        ...
        <div className='block lg:hidden'>
          <nav className='text-white lg:flex flex-col gap-x-5 text-[13px]  my-16 gap-5 font-bold uppercase leading-[25px] tracking-widest justify-end' style={{ display: 'flex' }}>
              <NavLink
                  to=""
        ...
        <div>
          <P className="!text-white !text-opacity-50 my-6">Audiophile is an all in one stop to fulfill your audio needs. We're a small team of music lovers and sound specialists who are devoted to helping you get the most out of personal audio. Come and visit our demo facility - we’re open 7 days a week.</P>
        </div>
        <div>
          <Span1 className="!text-white !text-opacity-50">Copyright 2021. All Rights Reserved</Span1>
        </div>
      </div>
      <div>
        <div className='hidden lg:block'>
            <nav className='text-white lg:flex gap-x-5 text-[13px] font-bold uppercase leading-[25px] tracking-widest justify-end'>
              <NavLink
                  to=""
                  style={({isActive}) => isActive ? activeStyles : null}
              >
         ...
         <div className='flex lg:justify-end justify-center items-center gap-4 mt-10'>
          <img src='assets/shared/desktop/icon-facebook.svg' alt='' className='' />
          <img src='assets/shared/desktop/icon-instagram.svg' alt='' className='' />
          <img src='assets/shared/desktop/icon-twitter.svg' alt='' className='' />
         </div>
      </div>
    </div>
  )
